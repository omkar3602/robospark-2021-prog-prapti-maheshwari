 ...
 * PRN: 12011016
 * 
B. Create a data structure TwoStacks that represents two stacks. Implementation of TwoStacks should use only one array, i.e., both stacks should use the same array for storing elements. Following functions must be supported by TwoStacks.
